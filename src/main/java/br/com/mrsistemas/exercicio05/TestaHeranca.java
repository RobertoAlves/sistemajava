...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp2 = new ContaEspecial(500, 3000, "048503", cliente2, ag1); // 2a. conta especial

        ContaPoupanca contaPoup = new ContaPoupanca("02/04/1985", 800, "9384", cliente2, ag1); // conta poupanca
